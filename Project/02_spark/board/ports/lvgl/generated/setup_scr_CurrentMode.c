...
void setup_scr_CurrentMode(lv_ui *ui)
{
	...
	lv_obj_set_pos(ui->CurrentMode_btn_1, 135, 189);
	lv_obj_set_size(ui->CurrentMode_btn_1, 90, 40);
	...
	lv_obj_set_style_bg_color(ui->CurrentMode_btn_1, lv_color_hex(0xBEAF14), LV_PART_MAIN|LV_STATE_DEFAULT);
